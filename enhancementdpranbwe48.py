...
LastEditTime: 2024-04-23 16:28:39
FilePath: \lastdance\enhancementdpranbwe48.py
Description: 第四章模型预测代码
...
if __name__ == "__main__":
    ...
    # 配置文件位置
    parser.add_argument("-C", "--config", default= "D:\\yhc\\BWE\\config\\enhancement\\dpranbwe.json", type=str, help="Model and dataset for enhancement (*.json).")
    # GPU配置
    parser.add_argument("-D", "--device", default="0", type=str, help="GPU for speech enhancement. default: CPU")
    # 输出文件位置
    parser.add_argument("-O", "--output_dir", default= "D:\\yhc\\BWE\\enhanced\\dpranshow", type=str, help="Where are audio save.")
    # 模型位置
    parser.add_argument("-M", "--model_checkpoint_path", default= "D:\\yhc\\BWE\\dpranbwe16_48\\checkpoints\\best_model.tar", type=str, help="Checkpoint.")
