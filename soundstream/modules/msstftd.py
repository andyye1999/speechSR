...
from soundstream.modules.conv import NormConv2d
...
class MultiScaleSTFTDiscriminator(nn.Module):
    ...
    """
    def __init__(self, filters: int, in_channels: int = 1, out_channels: int = 1,
                 n_ffts: tp.List[int] = [256, 512, 128], hop_lengths: tp.List[int] = [64, 128, 32],
                 win_lengths: tp.List[int] = [256, 512, 128], **kwargs):
        super().__init__()
